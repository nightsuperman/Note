...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->сохранитьToolStripMenuItem->Size = System::Drawing::Size(155, 22);
			...
			this->сохранитьКакToolStripMenuItem->Size = System::Drawing::Size(155, 22);
			...
			this->открытьToolStripMenuItem->Size = System::Drawing::Size(155, 22);
			...
			this->посмотретьЗаметкиToolStripMenuItem->Click += gcnew System::EventHandler(this, &NoteForm::посмотретьЗаметкиToolStripMenuItem_Click);
			// 
			// textBox1
			// 
...
private: System::Void посмотретьЗаметкиToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
